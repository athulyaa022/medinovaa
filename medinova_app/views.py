...
from .forms import ContactForm , AppointmentForm, TestimonialForm, BlogForm
...
def add_doctor(request):
    return render(request, 'admin_pages/add_doctor.html')   

@login_required(login_url='user_login')
def view_doctors(request):
    return render(request, 'admin_pages/view_doctors.html')
